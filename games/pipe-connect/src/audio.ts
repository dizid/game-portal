...
export const audio = {
  rotate() { tone(440, 0.04, 'triangle', 0.07) },
  connect() {
    tone(330, 0.08, 'sine', 0.08)
    setTimeout(() => tone(440, 0.08, 'sine', 0.08), 60)
  },
  water() {
    // Bubbling water-like sound
    tone(200, 0.1, 'sine', 0.06)
    setTimeout(() => tone(250, 0.1, 'sine', 0.05), 80)
    setTimeout(() => tone(300, 0.1, 'sine', 0.04), 160)
  },
  complete() {
